...
<body>
    ...
    <div class="container-fluid mt-5">
        <h3 style="text-align: center;">Change Cat Photo</h3>
        ...
        <!-- <form method="post" action="" enctype="multipart/form-data">
            <table>
                <tr>
                    <td>CURRENT PHOTO</td>
                    <td> <img src="<?= base_url('uploads/cats/' . $photo) ?>" width="128" height="128" alt=""></td>
                <tr>
                    <td>NEW PHOTO</td>
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-lg-6">
                    <div class="card" style="background-color: #8C9E80;">
                        <div class="card-body">
                            <h5 class="card-title text-center mb-4">Upload Cat Photo</h5>
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="email" class="form-label">CURRENT PHOTO</label>
                                    <img src="<?= base_url('uploads/cats/' . $photo) ?>" width="128" height="128" alt="">
                                </div>
                                <div class="mb-3">
